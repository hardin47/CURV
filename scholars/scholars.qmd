...
scholars <- tribble(
  ...
  "Small-Rodriguez", "Desi", "current", '<a target = "_blank" href = "">UCLA</a>','<a target = "_blank" href = "https://hardin47.github.io/CURV/scholars/small-rodriguez.html">CURV</a>', "data sovereignty", "data governance", "survey methods", "") %>%
  arrange(lname)
```
